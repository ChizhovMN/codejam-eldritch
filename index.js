...
console.log('Неисправелнные Баги \n 1. При втором замесе колоды выскакивает ошибка,но карты открываются \n 2.Если 2 раза замешать или более колоду на разных уровнях сложности - ломается трэкер. \n Для лучшей читаемости лучше перезагуржать страницу)')
